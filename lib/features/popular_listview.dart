...
import 'package:searching_app/pages/detail_screen.dart';
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            Row(
                              children: [
                                SvgPicture.asset(
                                    "${items.popularJobsList[index]["Photo"]}"),
                                SizedBox(
                                  width: 3.w,
                                ),
                                Column(
                            ...
                            Padding(
                              ...
                              child: InkWell(
                                ...
                                child: favIndex == true
                                    ? SvgPicture.asset(
                                        "assets/homepage_assets/fav.svg")
                                    : SvgPicture.asset(
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              SvgPicture.asset(
                                  "assets/homepage_assets/location.svg"),
                              SizedBox(
                                width: 3.5.w,
                              ),
                              Text(
